...
namespace RequestSuite\RequestPhpClient\Tests\Unit\Domains\Pay;
...
final class PayApiTest extends TestCase
{
    public function testPayRequestDelegatesToLegacyFacade(): void
    {
        ...
        $result = $api->payRequest(['amount' => 2500]);
    ...
    public function testLegacyAliasIsExposed(): void
    {
        $api = $this->apiWithResponses([], $adapter);

        self::assertInstanceOf(PayV1Api::class, $api->legacy);
        self::assertSame($api->legacy, $api->legacy);
    }

    /**
     * @param array<int, Response> $responses
     */
    private function apiWithResponses(array $responses, ?RecordingAdapter &$adapter): PayApi
    {
